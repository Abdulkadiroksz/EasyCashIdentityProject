...
{
    public class CustomerAccountManagerProcess : ICustomerAccountProcessService
    {
        private readonly ICustomerAccountProcessDal _customerAccountProcessDal;
        public CustomerAccountManagerProcess(ICustomerAccountProcessDal customerAccountProcessDal)
        {
